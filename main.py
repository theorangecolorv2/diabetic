...
from modules.click_on_image import lclick_on_image, rclick_on_image
...
from global_functions.choose_mission import choose_mission_and_run, config
from global_functions.get_pid import get_pid
from global_functions.kill_all import kill_frig, kill_all, kill_bs, shoot_all
